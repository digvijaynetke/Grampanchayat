      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-3 text-sm">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a href="tel:+91XXXXXXXX" className="flex items-center gap-1.5 hover:text-teal-200 transition">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
              </svg>
              <span>+91 XXXXXXXX</span>
            </a>
            <a href="https://wa.me/91XXXXXXXX" className="flex items-center gap-1.5 hover:text-teal-200 transition">
            ...
            <a href="mailto:chXXXXXXXXXXX@gmail.com" className="flex items-center gap-1.5 hover:text-teal-200 transition">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
