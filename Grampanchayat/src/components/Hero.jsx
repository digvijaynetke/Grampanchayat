...
const Hero = () => {
  ...
  const overviewText =
    'सभोवताली निसर्गरम्य डोंगर टेकड्यांच्या पायथ्याशी वसलेले ठाणेपाडा गाव नंदुरबार मुख्यालयापासून १६ किमी अंतरावर नंदुरबार-साक्री रस्त्यावर धुळे जिल्ह्याच्या सीमेवर स्थित आहे. गावाला लागून असलेल्या आमराई नदीचा उगम चुनखास येथे होतो आणि नदीकाठी झालेल्या सांस्कृतिक उपक्रमांनी गावाची ओळख जपली आहे. ब्रिटिश काळातील पूल, कापरा धरण आणि आजही उभ्या असलेल्या ऐतिहासिक वडाच्या वृक्षापर्यंत प्रत्येक वारसा गावाच्या स्मृतीत कोरला गेलाय.';

  return (
    <section
      id="home"
      className="relative overflow-hidden py-16 sm:py-20 md:py-24 min-h-[620px] md:min-h-[640px] lg:min-h-[700px]"
      style={{
        fontFamily:
          'Noto Sans, system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans Devanagari", sans-serif'
      }}
    >
      {/* Background Image */}
      <div 
  ...
  {/* Content Overlay */}
  <div className="relative min-h-[520px] flex flex-col items-center justify-center text-white z-10">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-5xl mx-auto mt-10">
            <div className="bg-white/85 backdrop-blur-sm text-gray-900 rounded-3xl shadow-2xl p-6 md:p-10 border border-white/50 animate-pulse">
              <p className="text-xl text-teal-700 font-semibold mb-3">
                <span
                  style={{
                    fontFamily:
                      'Noto Sans Devanagari, Noto Sans, system-ui, -apple-system, "Segoe UI", Roboto, Arial, sans-serif'
                  }}
                >
                  ठाणेपाडा: एक दृष्टिक्षेप
                </span>
              </p>
