      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-3">
          ...
          <div className="flex items-center gap-4">
            <img
              src={logo}
              alt="ठाणेपाडा ग्रामपंचायत लोगो"
              className="w-16 h-16 md:w-20 md:h-20 object-contain drop-shadow-none"
            />
            <div className="flex flex-col leading-snug">
              <div className="text-2xl md:text-4xl font-black text-gray-900 tracking-wide">
                ठाणेपाडा ग्रामपंचायत
              </div>
              <div
                className="text-[12px] md:text-sm font-semibold text-gray-600 tracking-wide"
                style={{
                  fontFamily:
                    'Noto Sans Devanagari, Noto Sans, system-ui, -apple-system, "Segoe UI", Roboto, Arial, sans-serif'
                }}
              >
                ग्रामपंचायत ता. जि. नंदुरबार
              </div>
            </div>
          </div>
