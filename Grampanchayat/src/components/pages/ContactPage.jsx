                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+XXXXXXXXX" className="text-gray-600 hover:text-teal-600 transition">
                        +91 XXXXXXXX
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:chdThanepada@gmail.com" className="text-gray-600 hover:text-teal-600 transition">
                        chdXXXXXXXXXXXXXX@gmail.com
                      </a>
                    </div>
                  </div>
